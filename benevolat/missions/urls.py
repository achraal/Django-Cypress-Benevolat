...
urlpatterns = [
    ...
    #path('moderation/associations/', moderer_associations, name='moderer_associations'),
    # path('moderation/association/<int:association_id>/approuver/', approuver_association, name='approuver_association'),
    # path('moderation/association/<int:association_id>/desapprouver/', desapprouver_association, name='desapprouver_association'),
    # path('association/<int:association_id>/valider/', valider_association, name='valider_association'),
    ...
    # path('valider_association/<int:user_id>/', valider_organisation, name='valider_organisation'),
